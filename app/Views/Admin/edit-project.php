...
<h3 class="mb-2">Edit Project <?= $project['nama']; ?></h3>

<div class="card shadow p-4">
    <form action="/admin/project/update/<?= $project['id'] ?>" method="POST" enctype="multipart/form-data">

        <div class="mb-3">
            <label for="nama" class="form-label">Nama Project</label>
            <input type="text" name="nama" class="form-control <?= ($validation->hasError('nama')) ? 'is-invalid' : '' ?>" id="nama" autofocus value="<?= (old('nama')) ? old('nama') : $project['nama']; ?>">
            <?php
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control <?= ($validation->hasError('deskripsi')) ? 'is-invalid' : '' ?>" name="deskripsi" id="deskripsi" rows="3"><?= (old('deskripsi')) ? (old('deskripsi')) : $project['deskripsi']; ?></textarea>
            <?php
        ...
        <div class="row g-5 mb-3">
            <div class="col-md">
                ...
                <input type="number" name="bedroom" class="form-control <?= ($validation->hasError('bedroom')) ? 'is-invalid' : '' ?>" id="bedroom" value="<?= (old('bedroom')) ? old('bedroom') : $project['bedroom']; ?>">
                <?php
            ...
            <div class="col-md">
                ...
                <input type="text" name="luas_area" class="form-control <?= ($validation->hasError('luas_area')) ? 'is-invalid' : '' ?>" id="luas_area" placeholder="cth: 4 Meter" value="<?= (old('luas_area')) ? old('luas_area') : $project['luas_area']; ?>">
                <?php
            ...
            <div class="col-md">
                ...
                <input type="text" name="luas_gedung" class="form-control <?= ($validation->hasError('luas_gedung')) ? 'is-invalid' : '' ?>" id="luas_gedung" placeholder="cth: 40 Meter" value="<?= (old('luas_gedung')) ? old('luas_gedung') : $project['luas_gedung']; ?>">
                <?php
            ...
            <div class="col-md">
                ...
                <input type="number" name="parkir" class="form-control <?= ($validation->hasError('parkir')) ? 'is-invalid' : '' ?>" id="parkir" value="<?= (old('parkir')) ? old('parkir') : $project['parkir']; ?>">
                <?php
            ...
            <div class="col-md">
                ...
                <input type="number" name="kamar_mandi" class="form-control <?= ($validation->hasError('kamar_mandi')) ? 'is-invalid' : '' ?>" id="kamar_mandi" value="<?= (old('kamar_mandi')) ? old('kamar_mandi') : $project['kamar_mandi']; ?>">
                <?php
        ...
        <div class="mb-3">
            ...
            <div class="input-group mb-3">
                ...
                <div class="custom-file">
                    <input type="hidden" name="thumbnail_temp" value="<?= $project['img_thumbnail'] ?>">
                    ...
                    <label class="custom-file-label" for="inputGroupFile01"><?= $project['img_thumbnail'] ?></label>
                </div>
            </div>
            <?php
        ...
        <div class="row g-3 mb-3">
            <div class="col-md">
                ...
                <div class="input-group mb-3">
                    ...
                    <div class="custom-file">
                        <input type="hidden" name="image_1_temp" value="<?= $project['img_gallery_1'] ?>">
                        ...
                        <label class="custom-file-label" for="inputGroupFile01"><?= $project['img_gallery_1'] ?></label>
                    </div>
                </div>
                <?php
            ...
            <div class="col-md">
                ...
                <div class="input-group mb-3">
                    ...
                    <div class="custom-file">
                        <input type="hidden" name="image_2_temp" value="<?= $project['img_gallery_2'] ?>">
                        ...
                        <label class="custom-file-label" for="inputGroupFile02"><?= $project['img_gallery_2'] ?></label>
                    </div>
                </div>
                <?php
            ...
            <div class="col-md">
                ...
                <div class="input-group mb-3">
                    ...
                    <div class="custom-file">
                        <input type="hidden" name="image_3_temp" value="<?= $project['img_gallery_3'] ?>">
                        ...
                        <label class="custom-file-label" for="inputGroupFile03"><?= $project['img_gallery_3'] ?></label>
                    </div>
                </div>
                <?php
        ...
        <div class="mb-3">
            ...
            <div class="input-group mb-3">
                ...
                <div class="custom-file">
                    <input type="hidden" name="video_temp" value="<?= $project['video'] ?>">
                    ...
                    <label class="custom-file-label" for="inputGroupFile02"><?= $project['video'] ?></label>
                </div>
            </div>
            <?php
